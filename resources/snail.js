// SNAIL.JS API
// Version 1.9.1
// By TechnologySnail {email.technologysnail@gmail.com}
// Shows a snail on the bottom of your website when you create an object with `snail = new mySnail()`.
// For all who may want to use, with the requirement of the absence of false attribution.
...
class mySnail {
    constructor(Freeze = false, Size = 0.25, Speed = 0.4, Colors = ["#00f2ff", "#003fff", "#ffaa00", "#ffe500"]) {
        this.randomID = Math.random().toString(16).slice(2);
        this.speed = Speed * (1+0.3*Math.cos(Math.random()*Math.PI));
        this.frozen = Freeze;
        ...
        this.snail.style = 'position:fixed;bottom-margin:0px;bottom:-5px;left:-1000px;padding:0px;pointer-events:none;background:none';
