var mySnail = {
    ...
    run : function() {
        ...
        document.getElementsByClassName("mySnail")[0].children[1].children[0].children[0].attributes.to.value = (4*window.innerWidth).toString() + " 0";
    },
    snail : null,
    frozen : false,
    setSize : function(newSize) {
        ...
        if (!this.frozen) {
            this.snail.children[0].children[1].children[0].children[0].attributes.to.value = ((1/newSize)*window.innerWidth).toString() + " 0";
        }
    },
